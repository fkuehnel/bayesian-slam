...
\beq
    ...
    \frac{1}{2}[{\bf T}]_\times + \beta\,{\bf r}{\bf T}^T
    + \alpha\,{\bf T}{\bf r}^T
    + \bar T\!\left[\beta\,\mathsf{I}
    - (2\beta+\alpha)\,{\bf r}{\bf r}^T\right],
    \label{eq:dSinvTdOmega}
\eeq
where $\bar T = {\bf r}\cdot{\bf T}$ is the axial component of ${\bf T}$ and
\beq
    \alpha = {1\over 4}\csc^2{\Theta\over 2}\,(\sin\Theta - \Theta)\,,\quad
    \beta = {1\over\Theta} - {1\over 2}\cot{\Theta\over2}\,.
